...
# descrição acima informada (retirar o melhor e o pior salto e depois calcular a média com as 
# notas restantes). As notas não são informados ordenadas. Um exemplo de saída do programa deve 
