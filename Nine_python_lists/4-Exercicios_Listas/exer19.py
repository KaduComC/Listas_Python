...
# ao final o resultado da mesma. O programa deverá ler os valores até ser informado o 
# valor 0, que encerra a entrada dos dados. Não deverão ser aceitos valores além dos 
# válidos para o programa (0 a 6). Os valores referentes a cada uma das opções devem 
# ser armazenados num vetor. Após os dados terem sido completamente informados, 
