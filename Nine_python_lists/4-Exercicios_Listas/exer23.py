...
# disco no seu servidor de arquivos. Para tentar resolver este problema, o Administrador de 
# Rede precisa saber qual o espaço ocupado pelos usuários, e identificar os usuários com 
# maior espaço ocupado. Através de um programa, baixado da Internet, ele conseguiu gerar o 
...
# de uma função separada, que será chamada pelo programa principal. O cálculo do percentual 
