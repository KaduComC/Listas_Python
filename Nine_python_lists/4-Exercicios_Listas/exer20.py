...
# a.Cada funcionário receberá o equivalente a 20% do seu salário bruto de dezembro; a.O piso do 
# abono será de 100 reais, isto é, aqueles funcionários cujo salário for muito baixo, 
# recebem este valor mínimo; Neste momento, não se deve ter nenhuma preocupação com colaboradores 
# com tempo menor de casa, descontos, impostos ou outras particularidades. Seu programa deverá 
# permitir a digitação do salário de um número indefinido (desconhecido) de salários. 
# Um valor de salário igual a 0 (zero) encerra a digitação. Após a entrada de todos os dados 
# o programa deverá calcular o valor do abono concedido a cada colaborador, de acordo com a 
